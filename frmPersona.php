...
<form id="form1" name="form1" method="post" action="frmPersona.php">
  <table width="400" border="0">
    <tr> <td> </td>
     <td>
     <input name="txtIdPersona" type="text" value="<?php echo isset($_GET['pid_persona']) ? $_GET['pid_persona'] : '';?>" id="txtIdPersona" />
     </td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="80">Edad</td>
      <td width="225">	  	  
        <input name="txtEdad" type="text" value="<?php echo $edad= isset($_GET['pedad']) ? $_GET['pedad'] : ''; ?>" id="txtEdad" />
      </td>
    </tr>
   ...
   <tr>
	...
	<td colspan="2">
        Buscar por       
        <input type="radio" name="grupo" value="1" checked="checked" <?php if (isset($_POST['grupo']) && $_POST['grupo']=="1") echo "checked"; ?> />
        Codigo
...
//programa principal
$boton= isset($_POST['botones']) ? $_POST['botones'] :null;
